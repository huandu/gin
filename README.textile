...
With this engine, programmers should be able to focus on game logic and graphic effects, just like programming in flash. It also implements MovieClip equivalent concept - the layers. Engine user can move/resize/render layers independently.
