...
If you want to play with <code>gin</code> now, see "here":http://www.realdodo.com/gin-samples. Clone the "gin-samples":https://github.com/huandu/gin-samples project on github for sample source code.
